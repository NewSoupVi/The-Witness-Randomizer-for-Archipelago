...
extern inline std::vector<int> lasers = {
	0x0360D, // Symmetry
	0x03615, // Swamp
	0x09DE0, // Bunker
	0x17CA4, // Monastery
...
extern inline std::vector<int> millElevatorControlOptions = {
...
extern inline std::vector<int> tutorialBackLeftOptions = {
	0x0008D, // Glass Factory Rotational Symmetry 1
	0x00081, // Glass Factory Rotational Symmetry 2
...
extern inline std::vector<int> tutorialBackLeftExpertOptions = {
...
extern inline std::vector<int> utmPerspectiveSet = {
...
extern inline std::vector<int> challengePanels = {
...
extern inline std::vector<int> mountainMultipanel = {
...
extern inline std::vector<int> squarePanels = {
...
extern inline std::vector<int> arrowPanels = {
    0x17CFB, // Outside Tutorial Discard
    0x3C12B, // Glass Factory Discard
    0x17CE7, // Desert Discard
    0x17CF0, // Mill Discard
...
extern inline std::vector<int> glassPanels = {
    0x01A54, // Glass Factory Entry
    0x00086, // Glass Factory Vertical Symmetry 1
    0x00087, // Glass Factory Vertical Symmetry 2
    0x00059, // Glass Factory Vertical Symmetry 3
...
extern inline std::vector<int> squarePanelsExpertBanned = {
    0x09E7A, // Mountain 1 Green 1
    0x09E71, // Mountain 1 Green 2
    0x09E72, // Mountain 1 Green 3
    0x09E69, // Mountain 1 Green 4
...
extern inline std::vector<int> desertPanels = {
...
extern inline std::vector<int> desertPanelsWide = {
    0x0A15C, //wide desert panel curve 1
    0x09FFF, //wide desert panel curve 2
};

extern inline std::vector<int> orchard{
...
extern inline std::vector<int> transparent = {
...
extern inline std::vector<int> shadowsPanels = {
...
extern inline std::vector<int> monasteryPanels = {
	0x00B10, // Monastery Left Door
	0x00C92, // Monastery Right Door
...
extern inline std::vector<int> bunkerPanels = {
...
extern inline std::vector<int> junglePanels = {
...
extern inline std::vector<int> nothingPanels = {
