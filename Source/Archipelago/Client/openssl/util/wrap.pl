...
BEGIN {
    ...
    require 'F:/Dokumente/The-Witness-Randomizer-for-Archipelago/Source/Archipelago/Client/openssl/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = 'F:/Dokumente/The-Witness-Randomizer-for-Archipelago/Source/Archipelago/Client/openssl/test/fips-and-base.cnf';
    shift;
