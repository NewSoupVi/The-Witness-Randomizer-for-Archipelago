...
public:
	APWatchdog(APClient* client, std::map<int, int> mapping, std::map<int, std::vector<std::string>> logHints, int lastPanel, PanelLocker* p, HWND skipButton1, HWND availableSkips1) : Watchdog(1) {
